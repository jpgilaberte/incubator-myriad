...
public class AcceptOffers extends PostAndAcceptResponse{

    private static final Logger LOGGER = LoggerFactory.getLogger(AcceptOffers.class);
    private final List<MesosV1.OfferID> offerIds;
    private final List<MesosV1.Offer.Operation> operations;
    private final MesosV1.Filters filters;

    public AcceptOffers(final MesosDriverHttpApi driver, final List<MesosV1.OfferID> offerIds, final List<MesosV1.Offer.Operation> operations, final MesosV1.Filters filters){
        super(driver);
    ...
    protected SchedulerV1.Call createCall(){
        ...
        accept.setOperations(operations);
